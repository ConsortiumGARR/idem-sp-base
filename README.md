...
DOCKER_BUILDKIT=1 docker build --build-arg SP_CERT_PATH="sp.aai-test.garr.it/sp-certs/staging" --no-cache -f sp-base/docker/Dockerfile --target idem -t gitlab.dir.garr.it:4567/idem/idem-sp/sp.aai-test.garr.it:1.0.0 .
